...
import com.huawei.hmscore.industrydemo.inteface.MemberCheckCallback;
import com.huawei.hmscore.industrydemo.inteface.MemberRefundListener;
...
public class MemberUtil {
            ...
            for (String item : list) {
                try {
                    ...
                    if (subIsvalid) {
                        ...
                        String time = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.ROOT).format(expirationDate);
                        if (memberCheckCallback != null) {
    ...
    public boolean isMember(User user) {
        ...
        return !user.isAutoRenewing() && user.getExpirationDate() > System.currentTimeMillis();
    }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(msg)) {
                    if (msg.contains("access_token")) {
                        ...
                        String accessToken = "APPAT:" + accessJson.get("access_token");
                        Log.d(TAG, "accessToken:" + accessToken);
                        accessToken =
                            Base64.encodeToString(accessToken.getBytes(Charset.defaultCharset()), Base64.DEFAULT);
                        Log.d(TAG, "accessToken:" + accessToken);
