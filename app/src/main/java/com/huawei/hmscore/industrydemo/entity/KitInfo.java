...
public class KitInfo {
    ...
    public KitInfo(String kitOriginame, String kitOrigiFunc, int kitName, int kitFunction, String userId,
        Integer kitDescription, int kitUrl, String... kitColors) {
        ...
        String kitUrlStr = MainApplication.getContext().getString(kitUrl);
        setKitUrl(kitUrlStr);
    ...
    public void setKitFunction(int kitFunction) {
        ...
        String tempStr = MainApplication.getContext().getString(kitFunction);
    ...
    public void setKitName(int kitName) {
        ...
        String tempStr = MainApplication.getContext().getString(kitName);
